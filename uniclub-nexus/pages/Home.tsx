  ...
  return (
    <div className="space-y-10">
      <div className="flex justify-between items-center">
        <h2 className="text-2xl font-bold text-blue-900">{t('overview')}</h2>
      ...
      <div className="space-y-6">
        <h3 className="text-2xl font-bold text-blue-900">{t('recentActivity')}</h3>
        <div className="bg-white rounded-2xl border border-slate-100 shadow-sm min-h-[300px] flex flex-col items-center justify-center p-12">
           <div className="text-center">
             <p className="text-slate-400 text-lg font-medium mb-8">{t('noActivity')}</p>
