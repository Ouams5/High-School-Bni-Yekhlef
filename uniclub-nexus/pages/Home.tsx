...
import { Briefcase, FileText, Users, Activity, RefreshCw } from 'lucide-react';
...
export const Home = () => {
  ...
  const fetchStats = async () => {
      const [projects, announcements, events] = await Promise.all([
          db.getProjects(),
          db.getAnnouncements(),
          db.getEvents()
      ]);
      setCounts({
          ...
          assignments: announcements.length,
